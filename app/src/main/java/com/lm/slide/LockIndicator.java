...
//        patternPressed = getResources().getDrawable(R.mipmap.lock_pattern_node_pressed);
        patternNoraml = getResources().getDrawable(R.drawable.white);
        patternPressed = getResources().getDrawable(R.drawable.bule);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < numRow; i++) {
            for (int j = 0; j < numColum; j++) {
                paint.setColor(this.getResources().getColor(R.color.color_AC272D));
